...
public class Ardougne extends Base {
    ...
    public void init() {
        ...
        stageList.add(new RooftopStage("Gap", "Jump", new WorldPoint(2653, 3318, 3), 15610,  Arrays.asList(new WorldPoint(2654, 3318, 3), new WorldPoint(2655, 3318, 3), new WorldPoint(2656, 3318, 3))));
